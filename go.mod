module github.com/swdunlop/rig-go
...
require (
	...
	github.com/swdunlop/html-go v0.0.0-20250411234841-281e17af59bd
	github.com/swdunlop/zugzug-go v0.0.0-20240822231947-fefa295f546c
